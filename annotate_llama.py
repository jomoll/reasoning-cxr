...
prompt_base = (
    ...
    "   a. For cardiomegaly, use cardiothoracic ratio: normal if not enlarged, mild enlargement or marked enlargement.\n"
    "   b. For congestion, apply: (mild) vascular redistribution only; (moderate) interstitial edema (Kerley B lines, peribronchial cuffing, septal thickening); (severe) alveolar edema (bat-wing consolidations, alveolar fluid, air bronchograms).\n"
    "   c. For pleural effusion, apply: (mild) blunting of costophrenic angle only; (moderate) small layering effusion (<1/3 hemithorax height); (severe) moderate-large effusion (>1/3 with meniscus and possible mediastinal shift).\n"
    "   d. For consolidation patterns, distinguish: (mild) focal/lobar; (moderate) multifocal; (severe) diffuse/alveolar (e.g. ARDS pattern).\n"   
    "   e. For pneumothorax, apply: (mild) small (<2 cm apical rim, no mediastinal shift); (moderate) moderate (2-4 cm rim, no shift); (severe) large/tension (>4 cm rim or any mediastinal shift).\n"
